...
public enum MaterialEnums implements Versionable {
    /*
    ...
    */
    ...
    LINGERING_POTION_AWKWARD(PotionEnums.LINGERING,"AWKWARD", false, false, null, "LINGERING_POTION"),
    LINGERING_POTION_FIRE_RESISTANCE(PotionEnums.LINGERING, "FIRE_RESISTANCE", false, false, null, "LINGERING_POTION"),
    LINGERING_POTION_FIRE_RESISTANCE_EXTENDED(PotionEnums.LINGERING, "FIRE_RESISTANCE", true, false, null, "LINGERING_POTION"),
    LINGERING_POTION_HARMING_1(PotionEnums.LINGERING, "INSTANT_DAMAGE", false, false, null, "LINGERING_POTION"),
    LINGERING_POTION_HARMING_2(PotionEnums.LINGERING, "INSTANT_DAMAGE", false, true, null, "LINGERING_POTION"),
    LINGERING_POTION_HEALING_1(PotionEnums.LINGERING, "INSTANT_HEAL", false, false, null, "LINGERING_POTION"),
    LINGERING_POTION_HEALING_2(PotionEnums.LINGERING, "INSTANT_HEAL", false, true, null, "LINGERING_POTION"),
    LINGERING_POTION_INVISIBILITY(PotionEnums.LINGERING, "INVISIBILITY", false, false, null, "LINGERING_POTION"),
    LINGERING_POTION_INVISIBILITY_EXTENDED(PotionEnums.LINGERING, "INVISIBILITY", true, false, null, "LINGERING_POTION"),
    LINGERING_POTION_LEAPING_1(PotionEnums.LINGERING, "JUMP", false, false, null, "LINGERING_POTION"),
    LINGERING_POTION_LEAPING_1_EXTENDED(PotionEnums.LINGERING, "JUMP", true, false, null, "LINGERING_POTION"),
    LINGERING_POTION_LEAPING_2(PotionEnums.LINGERING, "JUMP", false, true, null, "LINGERING_POTION"),
    LINGERING_POTION_LUCK(PotionEnums.LINGERING, "LUCK", false, false, null, "LINGERING_POTION"),
    LINGERING_POTION_MUNDANE(PotionEnums.LINGERING, "MUNDANE", false, false, null, "LINGERING_POTION"),
    LINGERING_POTION_NIGHT_VISION(PotionEnums.LINGERING, "NIGHT_VISION", false, false, null, "LINGERING_POTION"),
    LINGERING_POTION_NIGHT_VISION_EXTENDED(PotionEnums.LINGERING, "NIGHT_VISION", true, false, null, "LINGERING_POTION"),
    LINGERING_POTION_POISON_1(PotionEnums.LINGERING, "POISON", false, false, null, "LINGERING_POTION"),
    LINGERING_POTION_POISON_1_EXTENDED(PotionEnums.LINGERING, "POISON", true, false, null, "LINGERING_POTION"),
    LINGERING_POTION_POISON_2(PotionEnums.LINGERING, "POISON", false, true, null, "LINGERING_POTION"),
    LINGERING_POTION_REGENERATION_1(PotionEnums.LINGERING, "REGEN", false, false, null, "LINGERING_POTION"),
    LINGERING_POTION_REGENERATION_1_EXTENDED(PotionEnums.LINGERING, "REGEN", true, false, null, "LINGERING_POTION"),
    LINGERING_POTION_REGENERATION_2(PotionEnums.LINGERING, "REGEN", false, true, null, "LINGERING_POTION"),
    LINGERING_POTION_SLOW_FALLING(PotionEnums.LINGERING, "SLOW_FALLING", false, false, null, "LINGERING_POTION"),
    LINGERING_POTION_SLOW_FALLING_EXTENDED(PotionEnums.LINGERING, "SLOW_FALLING", true, false, null, "LINGERING_POTION"),
    LINGERING_POTION_SLOWNESS_1(PotionEnums.LINGERING, "SLOWNESS", false, false, null, "LINGERING_POTION"),
    LINGERING_POTION_SLOWNESS_1_EXTENDED(PotionEnums.LINGERING, "SLOWNESS", true, false, null, "LINGERING_POTION"),
    LINGERING_POTION_SLOWNESS_2(PotionEnums.LINGERING, "SLOWNESS", false, true, null, "LINGERING_POTION"),
    LINGERING_POTION_STRENGTH_1(PotionEnums.LINGERING, "STRENGTH", false, false, null, "LINGERING_POTION"),
    LINGERING_POTION_STRENGTH_1_EXTENDED(PotionEnums.LINGERING, "STRENGTH", true, false, null, "LINGERING_POTION"),
    LINGERING_POTION_STRENGTH_2(PotionEnums.LINGERING, "STRENGTH", false, true, null, "LINGERING_POTION"),
    LINGERING_POTION_SWIFTNESS_1(PotionEnums.LINGERING, "SPEED", false, false, null, "LINGERING_POTION"),
    LINGERING_POTION_SWIFTNESS_1_EXTENDED(PotionEnums.LINGERING, "SPEED", true, false, null, "LINGERING_POTION"),
    LINGERING_POTION_SWIFTNESS_2(PotionEnums.LINGERING, "SPEED", false, true, null, "LINGERING_POTION"),
    LINGERING_POTION_THICK(PotionEnums.LINGERING, "THICK", false, false, null, "LINGERING_POTION"),
    LINGERING_POTION_TURTLE_MASTER_1(PotionEnums.LINGERING, "TURTLE_MASTER", false, false, null, "LINGERING_POTION"),
    LINGERING_POTION_TURTLE_MASTER_1_EXTENDED(PotionEnums.LINGERING, "TURTLE_MASTER", true, false, null, "LINGERING_POTION"),
    LINGERING_POTION_TURTLE_MASTER_2(PotionEnums.LINGERING, "TURTLE_MASTER", false, true, null, "LINGERING_POTION"),
    LINGERING_POTION_WATER(PotionEnums.LINGERING, "WATER", false, false, null, "LINGERING_POTION"),
    LINGERING_POTION_WATER_BREATHING(PotionEnums.LINGERING, "WATER_BREATHING", false, false, null, "LINGERING_POTION"),
    LINGERING_POTION_WATER_BREATHING_EXTENDED(PotionEnums.LINGERING, "WATER_BREATHING", true, false, null, "LINGERING_POTION"),
    LINGERING_POTION_WEAKNESS(PotionEnums.LINGERING, "WEAKNESS", false, false, null, "LINGERING_POTION"),
    LINGERING_POTION_WEAKNESS_EXTENDED(PotionEnums.LINGERING, "WEAKNESS", true, false, null, "LINGERING_POTION"),
    ...
    POTION("POTION"),
    POTION_AWKWARD(PotionEnums.NORMAL, "AWKWARD", false, false, "POTION"),
    POTION_FIRE_RESISTANCE(PotionEnums.NORMAL, "FIRE_RESISTANCE", false, false, "POTION"),
    POTION_FIRE_RESISTANCE_EXTENDED(PotionEnums.NORMAL, "FIRE_RESISTANCE", true, false, "POTION"),
    POTION_HARMING_1(PotionEnums.NORMAL, "INSTANT_DAMAGE", false, false, "POTION"),
    POTION_HARMING_2(PotionEnums.NORMAL, "INSTANT_DAMAGE", false, true, "POTION"),
    POTION_HEALING_1(PotionEnums.NORMAL, "INSTANT_HEAL", false, false, "POTION"),
    POTION_HEALING_2(PotionEnums.NORMAL, "INSTANT_HEAL", false, true, "POTION"),
    POTION_INVISIBILITY(PotionEnums.NORMAL, "INVISIBILITY", false, false, "POTION"),
    POTION_INVISIBILITY_EXTENDED(PotionEnums.NORMAL, "INVISIBILITY", true, false, "POTION"),
    POTION_LEAPING_1(PotionEnums.NORMAL, "JUMP", false, false, "POTION"),
    POTION_LEAPING_1_EXTENDED(PotionEnums.NORMAL, "JUMP", true, false, "POTION"),
    POTION_LEAPING_2(PotionEnums.NORMAL, "JUMP", false, true, "POTION"),
    POTION_LUCK(PotionEnums.NORMAL, "LUCK", false, false, "POTION"),
    POTION_MUNDANE(PotionEnums.NORMAL, "MUNDANE", false, false, "POTION"),
    POTION_NIGHT_VISION(PotionEnums.NORMAL, "NIGHT_VISION", false, false, "POTION"),
    POTION_NIGHT_VISION_EXTENDED(PotionEnums.NORMAL, "NIGHT_VISION", true, false, "POTION"),
    POTION_POISON_1(PotionEnums.NORMAL, "POISON", false, false, "POTION"),
    POTION_POISON_1_EXTENDED(PotionEnums.NORMAL, "POISON", true, false, "POTION"),
    POTION_POISON_2(PotionEnums.NORMAL, "POISON", false, true, "POTION"),
    POTION_REGENERATION_1(PotionEnums.NORMAL, "REGEN", false, false, "POTION"),
    POTION_REGENERATION_1_EXTENDED(PotionEnums.NORMAL, "REGEN", true, false, "POTION"),
    POTION_REGENERATION_2(PotionEnums.NORMAL, "REGEN", false, true, "POTION"),
    POTION_SLOW_FALLING(PotionEnums.NORMAL, "SLOW_FALLING", false, false, "POTION"),
    POTION_SLOW_FALLING_EXTENDED(PotionEnums.NORMAL, "SLOW_FALLING", true, false, "POTION"),
    POTION_SLOWNESS_1(PotionEnums.NORMAL, "SLOWNESS", false, false, "POTION"),
    POTION_SLOWNESS_1_EXTENDED(PotionEnums.NORMAL, "SLOWNESS", true, false, "POTION"),
    POTION_SLOWNESS_2(PotionEnums.NORMAL, "SLOWNESS", false, true, "POTION"),
    POTION_STRENGTH_1(PotionEnums.NORMAL, "STRENGTH", false, false, "POTION"),
    POTION_STRENGTH_1_EXTENDED(PotionEnums.NORMAL, "STRENGTH", true, false, "POTION"),
    POTION_STRENGTH_2(PotionEnums.NORMAL, "STRENGTH", false, true, "POTION"),
    POTION_SWIFTNESS_1(PotionEnums.NORMAL, "SPEED", false, false, "POTION"),
    POTION_SWIFTNESS_1_EXTENDED(PotionEnums.NORMAL, "SPEED", true, false, "POTION"),
    POTION_SWIFTNESS_2(PotionEnums.NORMAL, "SPEED", false, true, "POTION"),
    POTION_THICK(PotionEnums.NORMAL, "THICK", false, false, "POTION"),
    POTION_TURTLE_MASTER_1(PotionEnums.NORMAL, "TURTLE_MASTER", false, false, "POTION"),
    POTION_TURTLE_MASTER_1_EXTENDED(PotionEnums.NORMAL, "TURTLE_MASTER", true, false, "POTION"),
    POTION_TURTLE_MASTER_2(PotionEnums.NORMAL, "TURTLE_MASTER", false, true, "POTION"),
    POTION_WATER(PotionEnums.NORMAL, "WATER", false, false, "POTION"),
    POTION_WATER_BREATHING(PotionEnums.NORMAL, "WATER_BREATHING", false, false, "POTION"),
    POTION_WATER_BREATHING_EXTENDED(PotionEnums.NORMAL, "WATER_BREATHING", true, false, "POTION"),
    POTION_WEAKNESS(PotionEnums.NORMAL, "WEAKNESS", false, false, "POTION"),
    POTION_WEAKNESS_EXTENDED(PotionEnums.NORMAL, "WEAKNESS", true, false, "POTION"),
    ...
    SPLASH_POTION_AWKWARD(PotionEnums.SPLASH, "AWKWARD", false, false, "POTION", "SPLASH_POTION"),
    SPLASH_POTION_FIRE_RESISTANCE(PotionEnums.SPLASH, "FIRE_RESISTANCE", false, false, "POTION", "SPLASH_POTION"),
    SPLASH_POTION_FIRE_RESISTANCE_EXTENDED(PotionEnums.SPLASH, "FIRE_RESISTANCE", true, false, "POTION", "SPLASH_POTION"),
    SPLASH_POTION_HARMING_1(PotionEnums.SPLASH, "INSTANT_DAMAGE", false, false, "POTION", "SPLASH_POTION"),
    SPLASH_POTION_HARMING_2(PotionEnums.SPLASH, "INSTANT_DAMAGE", false, true, "POTION", "SPLASH_POTION"),
    SPLASH_POTION_HEALING_1(PotionEnums.SPLASH, "INSTANT_HEAL", false, false, "POTION", "SPLASH_POTION"),
    SPLASH_POTION_HEALING_2(PotionEnums.SPLASH, "INSTANT_HEAL", false, true, "POTION", "SPLASH_POTION"),
    SPLASH_POTION_INVISIBILITY(PotionEnums.SPLASH, "INVISIBILITY", false, false, "POTION", "SPLASH_POTION"),
    SPLASH_POTION_INVISIBILITY_EXTENDED(PotionEnums.SPLASH, "INVISIBILITY", true, false, "POTION", "SPLASH_POTION"),
    SPLASH_POTION_LEAPING_1(PotionEnums.SPLASH, "JUMP", false, false, "POTION", "SPLASH_POTION"),
    SPLASH_POTION_LEAPING_1_EXTENDED(PotionEnums.SPLASH, "JUMP", true, false, "POTION", "SPLASH_POTION"),
    SPLASH_POTION_LEAPING_2(PotionEnums.SPLASH, "JUMP", false, true, "POTION", "SPLASH_POTION"),
    SPLASH_POTION_LUCK(PotionEnums.SPLASH, "LUCK", false, false, "POTION", "SPLASH_POTION"),
    SPLASH_POTION_MUNDANE(PotionEnums.SPLASH, "MUNDANE", false, false, "POTION", "SPLASH_POTION"),
    SPLASH_POTION_NIGHT_VISION(PotionEnums.SPLASH, "NIGHT_VISION", false, false, "POTION", "SPLASH_POTION"),
    SPLASH_POTION_NIGHT_VISION_EXTENDED(PotionEnums.SPLASH, "NIGHT_VISION", true, false, "POTION", "SPLASH_POTION"),
    SPLASH_POTION_POISON_1(PotionEnums.SPLASH, "POISON", false, false, "POTION", "SPLASH_POTION"),
    SPLASH_POTION_POISON_1_EXTENDED(PotionEnums.SPLASH, "POISON", true, false, "POTION", "SPLASH_POTION"),
    SPLASH_POTION_POISON_2(PotionEnums.SPLASH, "POISON", false, true, "POTION", "SPLASH_POTION"),
    SPLASH_POTION_REGENERATION_1(PotionEnums.SPLASH, "REGEN", false, false, "POTION", "SPLASH_POTION"),
    SPLASH_POTION_REGENERATION_1_EXTENDED(PotionEnums.SPLASH, "REGEN", true, false, "POTION", "SPLASH_POTION"),
    SPLASH_POTION_REGENERATION_2(PotionEnums.SPLASH, "REGEN", false, true, "POTION", "SPLASH_POTION"),
    SPLASH_POTION_SLOW_FALLING(PotionEnums.SPLASH, "SLOW_FALLING", false, false, "POTION", "SPLASH_POTION"),
    SPLASH_POTION_SLOW_FALLING_EXTENDED(PotionEnums.SPLASH, "SLOW_FALLING", true, false, "POTION", "SPLASH_POTION"),
    SPLASH_POTION_SLOWNESS_1(PotionEnums.SPLASH, "SLOWNESS", false, false, "POTION", "SPLASH_POTION"),
    SPLASH_POTION_SLOWNESS_1_EXTENDED(PotionEnums.SPLASH, "SLOWNESS", true, false, "POTION", "SPLASH_POTION"),
    SPLASH_POTION_SLOWNESS_2(PotionEnums.SPLASH, "SLOWNESS", false, true, "POTION", "SPLASH_POTION"),
    SPLASH_POTION_STRENGTH_1(PotionEnums.SPLASH, "STRENGTH", false, false, "POTION", "SPLASH_POTION"),
    SPLASH_POTION_STRENGTH_1_EXTENDED(PotionEnums.SPLASH, "STRENGTH", true, false, "POTION", "SPLASH_POTION"),
    SPLASH_POTION_STRENGTH_2(PotionEnums.SPLASH, "STRENGTH", false, true, "POTION", "SPLASH_POTION"),
    SPLASH_POTION_SWIFTNESS_1(PotionEnums.SPLASH, "SPEED", false, false, "POTION", "SPLASH_POTION"),
    SPLASH_POTION_SWIFTNESS_1_EXTENDED(PotionEnums.SPLASH, "SPEED", true, false, "POTION", "SPLASH_POTION"),
    SPLASH_POTION_SWIFTNESS_2(PotionEnums.SPLASH, "SPEED", false, true, "POTION", "SPLASH_POTION"),
    SPLASH_POTION_THICK(PotionEnums.SPLASH, "THICK", false, false, "POTION", "SPLASH_POTION"),
    SPLASH_POTION_TURTLE_MASTER_1(PotionEnums.SPLASH, "TURTLE_MASTER", false, false, "POTION", "SPLASH_POTION"),
    SPLASH_POTION_TURTLE_MASTER_1_EXTENDED(PotionEnums.SPLASH, "TURTLE_MASTER", true, false, "POTION", "SPLASH_POTION"),
    SPLASH_POTION_TURTLE_MASTER_2(PotionEnums.SPLASH, "TURTLE_MASTER", false, true, "POTION", "SPLASH_POTION"),
    SPLASH_POTION_WATER(PotionEnums.SPLASH, "WATER", false, false, "POTION", "SPLASH_POTION"),
    SPLASH_POTION_WATER_BREATHING(PotionEnums.SPLASH, "WATER_BREATHING", false, false, "POTION", "SPLASH_POTION"),
    SPLASH_POTION_WATER_BREATHING_EXTENDED(PotionEnums.SPLASH, "WATER_BREATHING", true, false, "POTION", "SPLASH_POTION"),
    SPLASH_POTION_WEAKNESS(PotionEnums.SPLASH, "WEAKNESS", false, false, "POTION", "SPLASH_POTION"),
    SPLASH_POTION_WEAKNESS_EXTENDED(PotionEnums.SPLASH, "WEAKNESS", true, false, "POTION", "SPLASH_POTION"),
    SPONGE("SPONGE"),
    ...
    TIPPED_ARROW_FIRE_RESISTANCE(PotionEnums.TIPPED_ARROW, "FIRE_RESISTANCE", false, false, "ARROW", "TIPPED_ARROW"),
    TIPPED_ARROW_FIRE_RESISTANCE_EXTENDED(PotionEnums.TIPPED_ARROW, "FIRE_RESISTANCE", true, false, "ARROW", "TIPPED_ARROW"),
    TIPPED_ARROW_HARMING_1(PotionEnums.TIPPED_ARROW, "INSTANT_DAMAGE", false, false, "ARROW", "TIPPED_ARROW"),
    TIPPED_ARROW_HARMING_2(PotionEnums.TIPPED_ARROW, "INSTANT_DAMAGE", false, true, "ARROW", "TIPPED_ARROW"),
    TIPPED_ARROW_HEALING_1(PotionEnums.TIPPED_ARROW, "INSTANT_HEAL", false, false, "ARROW", "TIPPED_ARROW"),
    TIPPED_ARROW_HEALING_2(PotionEnums.TIPPED_ARROW, "INSTANT_HEAL", false, true, "ARROW", "TIPPED_ARROW"),
    TIPPED_ARROW_INVISIBILITY(PotionEnums.TIPPED_ARROW, "INVISIBILITY", false, false, "ARROW", "TIPPED_ARROW"),
    TIPPED_ARROW_INVISIBILITY_EXTENDED(PotionEnums.TIPPED_ARROW, "INVISIBILITY", true, false, "ARROW", "TIPPED_ARROW"),
    TIPPED_ARROW_LEAPING_1(PotionEnums.TIPPED_ARROW, "JUMP", false, false, "ARROW", "TIPPED_ARROW"),
    TIPPED_ARROW_LEAPING_1_EXTENDED(PotionEnums.TIPPED_ARROW, "JUMP", true, false, "ARROW", "TIPPED_ARROW"),
    TIPPED_ARROW_LEAPING_2(PotionEnums.TIPPED_ARROW, "JUMP", false, true, "ARROW", "TIPPED_ARROW"),
    TIPPED_ARROW_LUCK(PotionEnums.TIPPED_ARROW, "LUCK", false, false, "ARROW", "TIPPED_ARROW"),
    TIPPED_ARROW_NIGHT_VISION(PotionEnums.TIPPED_ARROW, "NIGHT_VISION", false, false, "ARROW", "TIPPED_ARROW"),
    TIPPED_ARROW_NIGHT_VISION_EXTENDED(PotionEnums.TIPPED_ARROW, "NIGHT_VISION", true, false, "ARROW", "TIPPED_ARROW"),
    TIPPED_ARROW_POISON_1(PotionEnums.TIPPED_ARROW, "POISON", false, false, "ARROW", "TIPPED_ARROW"),
    TIPPED_ARROW_POISON_1_EXTENDED(PotionEnums.TIPPED_ARROW, "POISON", true, false, "ARROW", "TIPPED_ARROW"),
    TIPPED_ARROW_POISON_2(PotionEnums.TIPPED_ARROW, "POISON", false, true, "ARROW", "TIPPED_ARROW"),
    TIPPED_ARROW_REGENERATION_1(PotionEnums.TIPPED_ARROW, "REGEN", false, false, "ARROW", "TIPPED_ARROW"),
    TIPPED_ARROW_REGENERATION_1_EXTENDED(PotionEnums.TIPPED_ARROW, "REGEN", true, false, "ARROW", "TIPPED_ARROW"),
    TIPPED_ARROW_REGENERATION_2(PotionEnums.TIPPED_ARROW, "REGEN", false, true, "ARROW", "TIPPED_ARROW"),
    TIPPED_ARROW_SLOW_FALLING(PotionEnums.TIPPED_ARROW, "SLOW_FALLING", false, false, "ARROW", "TIPPED_ARROW"),
    TIPPED_ARROW_SLOW_FALLING_EXTENDED(PotionEnums.TIPPED_ARROW, "SLOW_FALLING", true, false, "ARROW", "TIPPED_ARROW"),
    TIPPED_ARROW_SLOWNESS_1(PotionEnums.TIPPED_ARROW, "SLOWNESS", false, false, "ARROW", "TIPPED_ARROW"),
    TIPPED_ARROW_SLOWNESS_1_EXTENDED(PotionEnums.TIPPED_ARROW, "SLOWNESS", true, false, "ARROW", "TIPPED_ARROW"),
    TIPPED_ARROW_SLOWNESS_2(PotionEnums.TIPPED_ARROW, "SLOWNESS", false, true, "ARROW", "TIPPED_ARROW"),
    TIPPED_ARROW_STRENGTH_1(PotionEnums.TIPPED_ARROW, "STRENGTH", false, false, "ARROW", "TIPPED_ARROW"),
    TIPPED_ARROW_STRENGTH_1_EXTENDED(PotionEnums.TIPPED_ARROW, "STRENGTH", true, false, "ARROW", "TIPPED_ARROW"),
    TIPPED_ARROW_STRENGTH_2(PotionEnums.TIPPED_ARROW, "STRENGTH", false, true, "ARROW", "TIPPED_ARROW"),
    TIPPED_ARROW_SWIFTNESS_1(PotionEnums.TIPPED_ARROW, "SPEED", false, false, "ARROW", "TIPPED_ARROW"),
    TIPPED_ARROW_SWIFTNESS_1_EXTENDED(PotionEnums.TIPPED_ARROW, "SPEED", true, false, "ARROW", "TIPPED_ARROW"),
    TIPPED_ARROW_SWIFTNESS_2(PotionEnums.TIPPED_ARROW, "SPEED", false, true, "ARROW", "TIPPED_ARROW"),
    TIPPED_ARROW_TURTLE_MASTER_1(PotionEnums.TIPPED_ARROW, "TURTLE_MASTER", false, false, "ARROW", "TIPPED_ARROW"),
    TIPPED_ARROW_TURTLE_MASTER_1_EXTENDED(PotionEnums.TIPPED_ARROW, "TURTLE_MASTER", true, false, "ARROW", "TIPPED_ARROW"),
    TIPPED_ARROW_TURTLE_MASTER_2(PotionEnums.TIPPED_ARROW, "TURTLE_MASTER", false, true, "ARROW", "TIPPED_ARROW"),
    TIPPED_ARROW_WATER_BREATHING(PotionEnums.TIPPED_ARROW, "WATER_BREATHING", false, false, "ARROW", "TIPPED_ARROW"),
    TIPPED_ARROW_WATER_BREATHING_EXTENDED(PotionEnums.TIPPED_ARROW, "WATER_BREATHING", true, false, "ARROW", "TIPPED_ARROW"),
    TIPPED_ARROW_WEAKNESS(PotionEnums.TIPPED_ARROW, "WEAKNESS", false, false, "ARROW", "TIPPED_ARROW"),
    TIPPED_ARROW_WEAKNESS_EXTENDED(PotionEnums.TIPPED_ARROW, "WEAKNESS", true, false, "ARROW", "TIPPED_ARROW"),
    TNT("TNT"),
    ...
    ;
    private static final HashMap<String, MaterialEnums> CACHE = new HashMap<>();
    ...
    private byte data;
    MaterialEnums(String ...names) {
        this(0, names);
    }
    MaterialEnums(String name, int data) {
        names[0] = name;
        versionName = name;
        this.data = (byte) data;
    }
    MaterialEnums(String name, int spoofedData, Color color) {
        names[0] = name;
        versionName = name;
        this.data = (byte) spoofedData;
        attributes = "color=" + color.getRed() + ":" + color.getGreen() + ":" + color.getBlue();
    }
    MaterialEnums(PotionEnums base, String type, boolean extended, boolean upgraded, String ...names) {
        this.names = names;
        attributes = "upotion=" + base.name() + ":" + type + ":" + extended + ":" + upgraded;
    }
    MaterialEnums(String name, Enchantment enchant, int level) {
        names[0] = name;
        versionName = name;
        data = 0;
        attributes = "enchant=" + enchant.getName() + ":" + level;
    }
    MaterialEnums(int data, String ...names) {
        this.names = names;
        this.data = (byte) data;
    }
    ...
    @Deprecated
    public static MaterialEnums match(String name, byte data) {
        name = name.toUpperCase();
        if(CACHE.containsKey(name + data)) return CACHE.get(name + data);
        for(MaterialEnums u : values()) {
            if(u.getData() == data) {
    ...
    public static MaterialEnums matchSpawnEgg(ItemStack egg) {
        if(egg != null) {
            if(EIGHT) {
    ...
    public static MaterialEnums matchEnchantedBook(ItemStack book) {
    ...
    public static MaterialEnums getItem(Block block) {
        final Material type = block.getType();
        final String m = type.name();
        final byte d = block.getData();
        MaterialEnums t = null;
        if(!EIGHT && !NINE && !TEN && !ELEVEN && !TWELVE || m.contains("TERRACOTTA") || m.startsWith("TORCH") || m.startsWith("REDSTONE_TORCH") || m.contains("STAIRS") || m.equals("FLINT_AND_STEEL") || m.equals("SOIL") || m.equals("LADDER") || m.equals("BONE_BLOCK") || m.equals("OBSERVER") || m.contains("FENCE_GATE") || m.contains("TRAPDOOR") || m.contains("CHEST")
            ...
            if(d == 8) {
                t = MaterialEnums.ACACIA_WOOD;
            } else if(d == 12) {
                t = log2 ? MaterialEnums.ACACIA_WOOD : MaterialEnums.OAK_WOOD;
            } else if(d == 13) {
                t = log2 ? MaterialEnums.DARK_OAK_WOOD : MaterialEnums.SPRUCE_WOOD;
            } else if(d == 14) {
                t = MaterialEnums.BIRCH_WOOD;
            } else if(d == 15) {
                t = MaterialEnums.JUNGLE_WOOD;
            }
            ...
            if(TWELVE) {
                ...
                return MaterialEnums.WHITE_BED;
            }
        } else if(m.contains("CROP")) {
            return MaterialEnums.AIR;
        } else if(m.contains("PISTON_")) {
            return m.contains("_STICKY_") ? MaterialEnums.STICKY_PISTON : MaterialEnums.PISTON;
