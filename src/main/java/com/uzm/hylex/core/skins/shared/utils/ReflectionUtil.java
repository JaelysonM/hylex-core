...
public class ReflectionUtil {
  ...
  static {
    try {
      ...
      String version = org.bukkit.Bukkit.getServer().getClass().getPackage().getName().substring(org.bukkit.Bukkit.getServer().getClass().getPackage().getName().lastIndexOf('.') + 1);
      setObject(ReflectionUtil.class, null, "serverVersion", version);
      serverVersion= org.bukkit.Bukkit.getServer().getClass().getPackage().getName().substring(OBC_PACKAGE.length() + 1);
