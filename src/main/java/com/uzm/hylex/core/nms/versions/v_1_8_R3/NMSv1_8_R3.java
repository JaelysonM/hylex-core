...
public class NMSv1_8_R3 implements INMS {
    ...
    public IArmorStand createArmorStand(Location location, String name, HologramLine line) {
        ...
        IArmorStand armor = line == null ? new EntityStand(location) : new com.uzm.hylex.core.nms.versions.v_1_8_R3.entity.EntityArmorStand(((CraftWorld) location.getWorld()).getHandle(), line);
