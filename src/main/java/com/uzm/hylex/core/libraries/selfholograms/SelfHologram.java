...
package com.uzm.hylex.core.libraries.selfholograms;


import com.comphenix.tinyprotocol.Reflection;
import com.uzm.hylex.core.nms.reflections.MinecraftReflections;
...
public class SelfHologram {
    ...
    private void createPackets() {
        Reflection.MethodInvoker gravityMethod = (version.isAboveOrEqual(MinecraftVersion.V1_10) ?
        ...
        Reflection.MethodInvoker customNameMethod = Reflection.getMethod(ENTITY_CLASS, "setCustomName",
                version.isAboveOrEqual(MinecraftVersion.V1_13) ? CHAT_BASE_COMPONENT_CLASS : String.class);
...
//                Reflection.getConstructor(ENTITY_ARMOR_STAND_CLASS, worldClass));
        ...
        try {
            entityArmorStandConstructor = (version.isAboveOrEqual(MinecraftVersion.V1_14) ?
                    Reflection.getConstructor(ENTITY_ARMOR_STAND_CLASS, worldClass, double.class, double.class, double.class) :
                    Reflection.getConstructor(ENTITY_ARMOR_STAND_CLASS, worldClass));
        ...
        for (String line : text) {
            Object entityArmorStand = (version.isAboveOrEqual(MinecraftVersion.V1_14) ?
            ...
            if (!version.isAboveOrEqual(MinecraftVersion.V1_14)) {
    ...
    public void show(Player player) {
        ...
        for (int i = 0; i < text.size(); i++) {
            ...
            if (version.isAboveOrEqual(MinecraftVersion.V1_15)) {
